...
**Read `AGENTS.md` at the repository root before doing anything.** It is the single source of truth for this project: stack, the nine-agent squad, the pipeline, the spec-driven workflow in `.specs/`, code rules, quality bars, and git conventions.
