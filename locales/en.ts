const translations = {
  ...
  skills: {
    ...
    bento: {
      ...
      zeroDataLoss: "Zero Data Loss",
      nodeDriverApp: "Driver App (iShip)",
      nodeDriverAppSub: "Flutter & Firebase",
      nodeDriverAppBadge: "Field Edge",
      nodeDriverAppDetail: "Telemetry & Geolocation",
      nodeBff: "Core NestJS API",
      nodeBffSub: "TypeScript & PostgreSQL",
      nodeBffBadge: "Core API",
      nodeBffDetail: "PostgreSQL & Idempotency",
      nodeKafka: "Apache Kafka",
      nodeKafkaSub: "Event Broker",
      nodeKafkaBadge: "Message Bus",
      nodeKafkaDetail: "Partitioned & Replicated",
      nodeCloud: "AWS Cloud",
      nodeCloudSub: "ECS, Lambda (Python) & Terraform",
      nodeCloudBadge: "Async Consumers",
      nodeCloudDetail: "Multi-AZ Auto-Scaling",
      yearsValue: "5+ Years",
  ...
  projects: {
    ...
    cases: {
      iship: {
        ...
        subtitle:
          "Mobile app in Flutter, orchestrated by the core NestJS API backed by PostgreSQL, managing the end-to-end driver journey from DC loading to final delivery.",
        challengeTitle: "The Challenge",
        challenge:
          "Connect field drivers to nationwide distribution hubs with high availability, orchestrating the full operational journey (route offers, DC check-in, cargo invoice and volume scanning, and proof of delivery) reliably across the Flutter app, the core NestJS API, and broader logistics systems.",
        architectureTitle: "The Architecture",
        architecture:
          "Core NestJS / TypeScript API backed by PostgreSQL and legacy integration, using KafkaJS and Outbox pattern for resilient asynchronous messaging with the transportation system (TMS), alongside a Driver Availability Scale web panel built as a Microfrontend (React 19 / Vite Module Federation) with Vitest and SonarCloud, and AWS Lambda functions in Python for auxiliary tasks.",
        resultTitle: "The Result",
        result:
          "Unified and observable driver journey from end to end, reduced staging times at distribution hubs, streamlined cargo invoice scanning, and high operational stability.",
