  ...
  projects: {
    ...
    cases: {
      iship: {
        ...
        title: "iShip — Driver Ecosystem & Logistics Platform",
        productionBadge: "Production Logistics",
        subtitle:
          "Logistics ecosystem connecting drivers and distribution hubs via NestJS/PostgreSQL APIs, Kafka/Avro messaging, Python Lambdas, and React 19 web scale panel.",
        challengeTitle: "The Challenge",
        challenge:
          "Connect field drivers to nationwide distribution hubs with high availability, orchestrating the full operational journey (route offers, DC check-in, cargo invoice and volume scanning, and proof of delivery) while integrating new NestJS services with legacy transportation systems.",
        architectureTitle: "Architecture & Technical Execution",
        architecture:
          "Development of the core NestJS / TypeScript API with PostgreSQL, creation of Kafka producers and consumers with strongly-typed Apache Avro schemas (integrating NestJS and Laravel), and Python AWS Lambda functions acting as scheduled calculation crons and event bridges to legacy systems. Also developed the Driver Scale web frontend as a Microfrontend (React 19 / Vite).",
        resultTitle: "Technical Leadership & Observability",
        result:
          "As Tech Lead, I drive quarterly capacity planning and scope simplification with PM and Product Designer for predictable deliveries. Operationally, I perform proactive triage and diagnostics using New Relic, direct database queries, and Microsoft Clarity (session replays) before engaging the squad, ensuring operational stability and team focus.",
        tagline: "Event-Driven Architecture & Tech Leadership",
      },
      isend: {
        badge: "Full Stack Developer",
        team: "MadeiraMadeira • Operational Experience Team",
        title: "iSend — Transportation Management System (TMS)",
        telemetryUrl: "tms.isend.internal/telemetry",
        activeRoutesBadge: "1,100+ ACTIVE DISPATCH ROUTES",
        apmCategory: "APM & Observability",
        apmTitle: "New Relic Telemetry",
        apmDesc: "Structured logs & tracing",
        qualityCategory: "Code Quality",
        qualityTitle: "SonarQube CI Pipeline",
        qualityDesc: "Automated coverage gates",
        asyncCategory: "Async Processing",
        asyncTitle: "AWS Lambda (Python)",
        asyncDesc: "Isolated worker routines",
        subtitle:
          "Core transportation management system with over 1,100 routes in Laravel and PHP for freight dispatch, shipping manifests, and operational control.",
        challengeTitle: "The Challenge",
        challenge:
          "Maintain stability, resolve complex bugs, and deliver new features on a mission-critical platform with 1,100+ routes heavily used in daily freight dispatch and cargo invoice operations.",
