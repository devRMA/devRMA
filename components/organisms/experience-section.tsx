                                        ...
                                        <CardHeader>
                                            <CardTitle className="flex items-center justify-between">
                                                <div className="flex items-center gap-2">
                                                    {t(
                                                        `experience.companies.${company.id}.name`
                                                    ) || company.name}
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <div className="flex justify-between items-start">
                                                <CardTitle>
                                                    {t(
                                                        `experience.education.${education.id}.degree`
                                                    ) || education.degree}
                                                </CardTitle>
                                            </div>
                                            <CardDescription>
                                                {t(
                                                    `experience.education.${education.id}.institution`
                                        ...
                                        <CardContent>
                                            <EducationCard
                                                ...
                                                achievements={education.achievements?.map(
                                                    (achievement, idx) =>
                                                        t(
                                                            `experience.education.${education.id}.achievements.${idx}`
                                                        ) || achievement
                                                )}
                                                inProgressLabel={t(
                                                    "experience.inProgress"
                                                )}
                                                keyAchievementsLabel={t(
